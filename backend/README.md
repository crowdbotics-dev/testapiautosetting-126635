...
## Project Structure
    ...
    ├── testapiautosetting_126635  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126635`
...
2. Clone this repo and `cd testapiautosetting_126635`
